...
def get_os_pattern(fprint_template, debug):
    ...
    for line in data:
        ...
        for item in result.split('%'):
            ...
            if '-' in val:
                ...
                #
                if key == 'ISR':
                    os_pattern.ISR_MIN = _str2hexint(minVal)
                    os_pattern.ISR_MAX = _str2hexint(maxVal)
    ...
    # set IPL = IP total length
    os_pattern.ICMP_IPL = int(fp['U1']['IPL'])
